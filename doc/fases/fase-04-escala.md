...
- Cache de catálogo, offline, multi-moeda, eventos sazonais, BI avançado, app mobile — normalmente após núcleo estável (ver [backlog.md](../backlog.md)).
...
- [ ] Itens enterprise escolhidos para a fase: critérios de aceite específicos atendidos ou movidos ao [backlog.md](../backlog.md).

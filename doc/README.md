...
| **[projeto/](projeto/)** | Decisões **DEC-***, backlog, [qualidade-e-conformidade.md](projeto/qualidade-e-conformidade.md) (auditoria vs RNF), [vitrine-configuracao-aparencia.md](projeto/vitrine-configuracao-aparencia.md) (tema da vitrine pública), **[identidade-visual-e-paletas.md](projeto/identidade-visual-e-paletas.md)** (paletas painel/vitrine, gráficos, bases para logo e manual de marca), **[painel-ux-layout-formularios-precificacao.md](projeto/painel-ux-layout-formularios-precificacao.md)** (UX painel: título sticky e Guardar fixo; precificação MP+MO; validades), **[relatorios-analytics-roadmap.md](projeto/relatorios-analytics-roadmap.md)** (relatórios vs analytics), **[relatorios-definicoes-negocio.md](projeto/relatorios-definicoes-negocio.md)** (**DEC-22**), **[landing-site-produto.md](projeto/landing-site-produto.md)** (página inicial marketing, Fase 3.2), **[indice-documentacao-e-gaps.md](projeto/indice-documentacao-e-gaps.md)** (índice e lacunas), **[ideias-compartilhar-cardapio-estoque-por-produto.md](projeto/ideias-compartilhar-cardapio-estoque-por-produto.md)** (IP-12–14, DEC-23), rastreabilidade com `inicio_planejamento.txt`, proposta legada |
| **[fases/](fases/)** | Roadmap por fase (0–4), **3.1** (paridade mockup), **3.2** (impressão + landing marketing) e plano mestre |
